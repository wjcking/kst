...
public class ColorTable
{
    ...
    public static Color QQHighLightColor = Color.FromArgb(110, 205, 253);
    public static Color QQHighLightInnerColor = Color.FromArgb(73, 172, 231);
}
